...
public class BoneCpConnectionPool {
	...
	private static void initConfig(String driver, String url, String userName, String password)
	...
	public static void initPool(String driver, String url, String userName, String password)
			throws ClassNotFoundException {
		if (!isInit) {
			try {
				initConfig(driver, url, userName, password);
